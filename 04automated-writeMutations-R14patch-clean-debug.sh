...
do
	...
	sbatch 04sbatch-writeMutations-R14patch-clean-debug.sh -export=laneName -export=dataLocation -export=outputFileName -export=WTadjustedFlag -export=trimThreshold -export=FlashThreshold
done
